...
using CodeConnect.RoslynSearch;

namespace RoslynSearch_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new RoslynSearchPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(CodeConnect.RoslynSearch.GuidList.guidRoslynSearchCmdSet, (int)CodeConnect.RoslynSearch.PkgCmdIDList.cmdidSearchWithRoslyn);
